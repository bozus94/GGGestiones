Vue.component("cuadreComponent", {
	...
	methods: {
		calculate() {
			...
			const diferencia = this.datas.total - this.datas.caja;
		...
		<div class="card boder-light">
			...
			<div class="card-body fs-">
				...
				<div class="row row-cols-2 mx-auto my-3 justify-content-md-center align-content-center">
					<div class="col-6">
						<div class="form-floating mb-3">
							<input type="text" @click="verifyInput" @keyup="calculate" v-model="datas.billetes" class="form-control" placeholder="billetes" />
							<label for="billetes"> Billetes</label>
						</div>
					</div>
					<div class="col-6">
						<div class="form-floating mb-3">
							<input type="text" @click="verifyInput" @keyup="calculate" v-model="datas.monedas" class="form-control" placeholder="monedas" />
